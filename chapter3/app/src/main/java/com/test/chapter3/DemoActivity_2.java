...
import com.test.chapter3.ui.HorizontalScrollViewEx2;
import com.test.chapter3.ui.ListViewEx;
import com.test.chapter3.utils.MyUtils;
...
public class DemoActivity_2 extends Activity {
    ...
    private void initView(){
        ...
        for(int i=0; i<3; i++){
            ViewGroup layout = (ViewGroup)inflater.inflate(R.layout.content_layout2,
            ...
            createList(layout);
            mListContainer.addView(layout); //注意这里
        }
    }
